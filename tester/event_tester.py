...
class TestRunner:
    def __init__(self, program: Program, logger=None) -> None:
...
class Participant:
    def __init__(self, source_file, executables_dir, logs_dir):
...
class EventTester:
    def __init__(self, langid: str, settings: dict[str, str]) -> None:
        ...
        self.participants: List[Participant] = [
            Participant(source_files, self.executables_dir, self.logs_dir)
    ...
    def test_participant(self, participant: Participant):
        try:
            ...
            with Logger(participant.logs_file) as logger:
                ...
                runner: TestRunner = TestRunner(program, logger)
